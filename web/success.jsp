<%-- 
    Document   : success
    Created on : 19 May 2025, 2:07:27 am
    Author     : Azwan
--%>
...
<body>
    ...
    <main class="main-content">
            <div class="success-panel">
                ...
                <h2 class="success-heading">Treatment Record Added Successfully</h2>
                <p class="success-message">The treatment details have been successfully recorded in the system.</p>
